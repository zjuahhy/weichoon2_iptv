...
[
{"name":"MV","url":"./mv.txt"}, //2024/04/30 - cwc 支持相对路径
...
const VERSION = 'live2cms 20240430cwc';
//2024/04/30 - cwc
...
function getHome(url){
    ...
    if (url.startsWith('http')) { //2024/04/30 - cwc
        let tmp = url.split('//');
...
const http = function (url, options = {}) {
    if(options.method ==='POST' && options.data){
        ...
        options.headers = Object.assign({'content-type':'application/json; charset=utf-8'}, options.headers); //2024/04/30 - cwc
    }
